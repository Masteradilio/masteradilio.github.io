  ...
  const repairMessages = [
    ...messages,
    {
      ...
      content: [
        ...
        ...focusRules,
        'Keep wording factual. For BRB LLM/RAG/AI-agent work, use implemented rather than deployed. For BANPARÁ RAG work, use developed rather than deployed. For the BRB PIX fraud model, say that Adilio led end-to-end development rather than claiming deployment. Do not describe rag_agent_datasus as production-grade/production-ready RAG unless its canonical evidence says so.'
      ].filter(Boolean).join('\n')
    },
